...
public class Estudiante{
    ...
    public Estudiante(String codigo, String nombre, String telefono, String email, String direccion, Integer edad, String documento, String tipodoc, Integer creditos, Integer Semestre, String Estado){
        this.codigo=codigo;
        this.nombre=nombre;
...
public void promedioCreditosSemestre(){
  ...
  public void cursoTotalCreditos()
    ...
    //*Metodo para calcular si el estudiante es mayor de edad
    //* El promedio de creditos cursados
    //* Matricular proyecto de grado, el estudiante debe aver aprobado el 70% creditos y estar en 7 semestre
    //* Obtener el promedio de creditos por semestre
    //* Mostrar si el estudiante curso el total de creditos
    //* Actualizar el estado (El estudiante puede tener el estado: Matriculado, PFu)
